...
type DaoReferer struct {
	...
	Up func(SiteId, TopicId int64, Referer string) (int64, bool, error) `update TopicReferer set Click=Click+1 ,ClickAll=ClickAll+1 where SiteId=? and TopicId=? and Referer=?`
}
